...
####Explanations and Abductive reasoning
- __explanation generation__
	- task:
...
- __abductive inference__ (those which are non-deductive)
	- task:
...
good-mood(john) :- /** observation to explain **/ 
	did-well-on(john,e) :- 
		exam(e),
